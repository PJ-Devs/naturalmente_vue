<template>
    <section v-if="product" class="h-screen grid grid-cols-2 py-3 mt-20 mx-auto">
        ...
        <section class="flex flex-col w-[90%] mx-auto">
            ...
            <div class="flex flex-row justify-between py-5 border-t-2 border-b-2 border-gray-200 items-center">
            ...
            <div class="flex flex-row gap-3 py-5">
                <button class="primaryBtn w-full">
                    Agregar al carrito
                </button>
                <button class="primaryBtn bg-orange-300 hover:bg-orange-400 w-full">
                    Comprar
                </button>
            </div>
        </section>
    ...
    <div v-else class="flex justify-center items-center h-screen">
        <div class="animate-spin rounded-full h-32 w-32 border-t-4 border-b-4 my-auto border-[--accent]"></div>
    </div>
</template>
